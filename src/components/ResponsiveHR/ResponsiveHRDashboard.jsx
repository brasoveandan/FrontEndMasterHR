...
import ResponsiveHRLandingPage from "./ResponsiveHRLandingPage";

class ResponsiveHRDashboard extends React.Component {
    ...
    constructor(props){
        ...
        this.state = {render: <ResponsiveHRLandingPage/>}
    }
    ...
    show(type){
        switch(type){
            ...
            default: this.setState({render: <ResponsiveHRLandingPage/>})
        }
    }
...
const Dashboard = withRouter(ResponsiveHRDashboard );
