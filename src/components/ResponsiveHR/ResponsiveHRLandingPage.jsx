...
export default class ResponsiveHRLandingPage extends LandingPage{
            ...
            <div>
                {this.renderPage(
                    <p className="card-text">
                        ...
                        <br/>- poți vizualizare pontajul altor angajați
                        <br/>- poți adăuga pontaj pentru alți angajați
                        <br/>- poți încheia situația pontajelor pentru anumiți angajați
                    </p>
                )}
            </div>
        )
